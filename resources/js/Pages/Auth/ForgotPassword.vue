<template>
    ...
    <form @submit.prevent="submit">
        ...
        <div class="flex items-center justify-end mt-4">
            <BreezeButton class="w-full py-4 bg-amber-400 text-black hover:bg-amber-200 focus:bg-amber-200 focus:ring-0 " :class="{ 'opacity-25': form.processing }" :disabled="form.processing">
