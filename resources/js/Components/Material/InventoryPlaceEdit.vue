<template>
    ...
    <button @click="openModal()"  class="flex items-center rounded-xl text-sm border-2 border-zinc-900 px-2 py-2 text-zinc-900 font-semibold mr-3 hover:bg-zinc-900 hover:text-white">
