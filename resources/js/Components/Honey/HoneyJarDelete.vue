<template>
    <form @submit.prevent="deleteHoneyJar" @click="honey_jar_id = honey_jar.id">
...
export default {
    ...
    methods: {
        deleteHoneyJar() {
            Swal.fire({
                title: "Voulez-vous vraiment supprimer ce pot de miel ?",
                ...
                if (result.isConfirmed) {
                    useForm({}).delete(route('inventoryHoney.destroy', this.honey_jar_id), {
                        onSuccess() {
                            Swal.fire({
                                icon: 'success',
                                title: 'Pot de miel supprimé avec succès',
                                toast: true,
                                position: 'top-end',
